 ...
 * @return array
 */
function cohort_get_available_cohorts($currentcontext, $withmembers = 0, $offset = 0,
                                      $limit = 25, $search = '', $withcustomfields = false) {
    global $DB;
    ...
    if ($withcustomfields) {
        ...
        foreach ($cohorts as $cohort) {
            $cohort->customfields = $handler->get_instance_data($cohort->id);
        }
    }
