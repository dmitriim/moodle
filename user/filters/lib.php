...
require_once($CFG->dirroot.'/user/filters/courserolesubcat.php');
...
class user_filtering {
    ...
    public function __construct($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            $fieldnames = array('realname' => 0, 'lastname' => 1, 'firstname' => 1, 'username' => 1, 'email' => 1, 'city' => 1, 'country' => 1,
                                'confirmed' => 1, 'suspended' => 1, 'profile' => 1, 'courserole' => 1, 'courserolesubcat' => 0,  'systemrole' => 1,
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'courserolesubcat':  return new user_filter_courserolesubcat('courserolesubcat', get_string('courserole', 'filters'), $advanced);
