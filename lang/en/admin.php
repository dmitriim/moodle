...
$string['searchallavailablecourses_all'] = 'Search within all courses';
$string['searchallavailablecourses_desc'] = 'In some situations the search engine may not work when searching across a large number of courses. Set to search only enrolled courses if you need to restrict the number of courses searched. If you set search all courses, the output will be limited to name and description for courses a user can not access.';
