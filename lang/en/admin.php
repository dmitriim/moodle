...
$string['searchincludeallcourses'] = 'Include all courses';
$string['searchincludeallcourses_desc'] = 'If enabled, course name and summary of all courses will be included in the search result.';
